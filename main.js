...
const vizinhoTexture = textureLoader.load('public/vizinho.png');
...
const predio = await new GLTFLoader().loadAsync('./predio.glb');
...
const marquise = await new GLTFLoader().loadAsync('./marquise.glb');
